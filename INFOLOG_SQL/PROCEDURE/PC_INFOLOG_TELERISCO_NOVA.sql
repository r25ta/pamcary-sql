create or replace PROCEDURE    pc_mntcarga_telerisco_des
AS
...
BEGIN
  ...
  --SISTEMA ARMAZENA A DATA/HORA DA GERAÃÃO DO ARQUIVO I_FILE_DHR_PROCESS

...
,case
	when RV.ctl_vincd = 1264214 then 'SEMP'
	else 'ENTIDADE NAO FAZ PARTE DA OPERACAO SEMP'
end as OPERACAO 
...
, EV.num_latit as LATITUDE
, EV.num_longi as LONGITUDE
from
	...
	and O.ctl_opera_tip = 422
	inner join supervisor.endereco_vinculado EV 
	on ev.ctl_vincd = rv.ctl_vincd_rld

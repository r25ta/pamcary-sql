CREATE OR REPLACE PROCEDURE DBPROD.SP_INSERE_AVB_ATM
    (IN V_CTL_ATM BIGINT) RESULT SETS 1 ---MODIFIES SQL DATA
    NOT DETERMINISTIC NULL CALL LANGUAGE SQL EXTERNAL ACTION
BEGIN
DECLARE
    v_step smallint;
    --
    ...
    IF X_DUPLI1 IS NULL THEN
        SET X_DUPLI1 = (
                ...
                WHERE A.CTL_AVERB = B.CTL_AVERB
                    ...
                    --                      AND C.COD_DOCUM = c_atm.COD_CNPJ_SEG

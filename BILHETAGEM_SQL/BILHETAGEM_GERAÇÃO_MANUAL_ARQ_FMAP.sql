...
WHERE NOM_ARQUI LIKE '%emb202402-MENSAL_07000324707_rctrc_3836901085154%'
...
INSERT INTO DBPROD.DOWNLOAD_ARQUIVO(
	...
	NUM_ASCOM)
VALUES (2,
'emb202402-MENSAL_07000324707_rctrc_3836901085154.pdf',
0,
'teste',
CURRENT timestamp,
'S',
...
SELECT * FROM BIL_ARQUIVO_DOCUMENTO_WEB 
WHERE NOM_ARQUI LIKE '%emb202402-MENSAL_07000324707_rctrc_3836901085154%'
...
SELECT * FROM bilhet.TBIL_RETOR_FATURA_CIA 
WHERE SEQ_NUMER_FAT in (7000312061)

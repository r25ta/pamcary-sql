...
/*RETORNAR O SEGURADO COM APOLICE BAIXADA QUE NÃO ESTÁ CADASTRADO NA SEGURADO PARALELO, VERIFICAÇÃO É FEITA POR RAMO*/
...
WHERE 1=1
	...
	AND s.NUM_PROPT NOT BETWEEN 55000000 AND 55999999
	AND s.NUM_PROPT NOT BETWEEN 999000000 AND 999999999
	AND s.NUM_RAMO_SEG = 1 -- CODIGO RAMO
	AND CTL_CLIEN_PPS NOT IN (
						  	SELECT ctl_pesso FROM SEGURADO_PARALELO WHERE NUM_RAMO_SEG = 1 --CODIGO RAMO
						 )

...
-- AJUSTE PARA ELIMINAR FATURAS DUPLICADAS POR FALTA DE RELACIONAMENTO DO CAMPO NUM_CIA_PAM
-- SOLUCAO: INCLUSAO DA TABELA SEGURO.TSEG_PROPOSTA_SEGURO x BILHET.TBIL_PROPOSTA UTILIZANDO CAMPO NUM_CIA_PAM e NUM_APOLI 
CREATE VIEW BILHET.V_BIL_ENVIA_COBRANCA AS
SELECT
    DISTINCT f.SEQ_NUMER_FAT AS NOSSO_NUMERO,

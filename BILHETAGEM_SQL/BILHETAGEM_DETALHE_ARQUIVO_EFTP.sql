/*DETALHE ARQUIVO EFTP*/	
SELECT
	DISTINCT 
		CURRENT timestamp AS EMISSAO_PROPOSTA, 	
		CASE
...
WHERE 1 = 1
--				AND FATURA.SIT_ENVIO_FAT = ? 
AND FAT.SIT_FATUR NOT IN (1, 3, 6)
AND PROPOSTA.CTL_PEJUR_CIA = 37960
AND FAT.dhr_alter BETWEEN '2024-09-13 00:00:00' AND '2024-09-13 23:59:59'
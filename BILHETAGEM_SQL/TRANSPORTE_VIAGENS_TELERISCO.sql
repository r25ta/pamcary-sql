...
and date(A.dhr_entra)  between '2024-07-01 00:00:00' AND '2024-07-01 23:59:59'
...
SELECT
    ...
    COALESCE((SELECT p.COD_DOCUM_PRI FROM mdfe.RELAC_AVERB_MDFE mdf INNER JOIN DBPROD.TAVERBACAO_INDICE ai  
		ON ai.CTL_AVERB = mdf.CTL_AVERB
		INNER JOIN PAMAIS.TCRP_PESSOA p 
		ON p.CTL_PESSO = ai.CTL_PESSO 
		WHERE CTL_MANIF = MANIF.CTL_MANIF LIMIT 1),'00000000000000') AS COD_DOCUM_PRI,

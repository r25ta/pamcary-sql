SELECT 
     ...
     , (SELECT SUM(
                CASE WHEN TP.NUM_TARIF IN(36,37,66) THEN NVL(VC.VLR_TARIF,0.06)
                ...
                WHERE TP.SEQ_NUMER_PRS = P.SEQ_NUMER_PRS AND TP.NUM_TARIF IN (15,16,33,34,36,37,66)
       ) AS TARIFA_PROPOSTA 
...
SELECT * FROM APLBIL.BIL_VALOR_SOMA_TIPO_TARIFA
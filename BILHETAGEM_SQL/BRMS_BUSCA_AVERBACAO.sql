...
where ((vigenciata0_.DAT_INICI_VIG between '2023-03-01 00:00:00' and '2023-03-31 23:59:59') 
and (vigenciata0_.DAT_FIM_VIG between '2023-03-01 00:00:00' and '2023-03-31 23:59:59') 
or (vigenciata0_.DAT_INICI_VIG between '2023-03-01 00:00:00' and '2023-03-31 23:59:59') 
and (vigenciata0_.DAT_FIM_VIG not between '2023-03-01 00:00:00' and '2023-03-31 23:59:59') 
or (vigenciata0_.DAT_INICI_VIG not between '2023-03-01 00:00:00' and '2023-03-31 23:59:59') 
and (vigenciata0_.DAT_FIM_VIG between '2023-03-01 00:00:00' and '2023-03-31 23:59:59' ) 
or vigenciata0_.DAT_INICI_VIG<'2023-03-01 00:00:00' and vigenciata0_.DAT_FIM_VIG>'2023-03-31 23:59:59') 
...
where ((tarifaperc0_.DAT_INICI_VIG between '2023-03-01 00:00:00' and '2023-03-31 23:59:59') 
and (tarifaperc0_.DAT_FIM_VIG between '2023-03-01 00:00:00' and '2023-03-31 23:59:59') 
or (tarifaperc0_.DAT_INICI_VIG between '2023-03-01 00:00:00' and '2023-03-31 23:59:59') 
and (tarifaperc0_.DAT_FIM_VIG not between '2023-03-01 00:00:00' and '2023-03-31 23:59:59') 
or (tarifaperc0_.DAT_INICI_VIG not between '2023-03-01 00:00:00' and '2023-03-31 23:59:59') 
and (tarifaperc0_.DAT_FIM_VIG between '2023-03-01 00:00:00' and '2023-03-31 23:59:59') 
or tarifaperc0_.DAT_INICI_VIG<'2023-03-01 00:00:00' 
and tarifaperc0_.DAT_FIM_VIG>'2023-03-31 23:59:59') 
and (tipotarifa2_.NUM_TARIF in (1, 2, 8, 3, 4, 5, 6, 7, 9, 10, 15, 16, 31, 32, 33, 34, 35, 37, 38, 39, 14, 53, 36, 66, 74))
...
where averbacao0_1_.DHR_EMBAR<= '2023-03-31 23:59:59'
and proposta1_.NUM_APOLI=5400037652
...
SELECT * FROM bilhet.TBIL_VENCIMENTO_FATURA_PROPT tvfp  
WHERE SEQ_NUMER_PRS = 505976
...
WHERE tp.NUM_APOLI = 5400037652
AND ta.DHR_EMBAR<= '2023-03-31 23:59:59'
...
WHERE CTL_VIGEN_PEC IN (60879
,661)

SEQ_NUMER_AVB 
SELECT * FROM bilhet.TBIL_RELAC_VISAO_PERCU_PADRA trvpp 
WHERE SEQ_NUMER_AVB IN (1141288229
,1141288230
,1141288231
,1141288232
,1141288233
...
SELECT * FROM bilhet.TBIL_RELAC_VISAO_PERCU_PROPT trvpp2 
WHERE SEQ_NUMER_AVB IN (1141288229
,1141288230
,1141288231
,1141288232
